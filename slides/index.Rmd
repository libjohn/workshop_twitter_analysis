...
.f6.i.moon-gray[This is not a text analysis workshop.  The foundations of text analysis require considerably more time that we have. This is a demonstration on leveraging the following packages to gather twitter data: `tidyverse`, ropensci's `rtweet`, and the `tidytext` ]
